...
export default function App() {
  ...
  const services = [
    { icon: <Shield size={20} />, label: "Hygiene", desc: "Routine dental examinations and hygiene care." },
    { icon: <Activity size={20} />, label: "Restorative", desc: "Tooth pain evaluation and root canal treatment." },
    { icon: <Zap size={20} />, label: "Implants", desc: "Replacement of missing teeth with long-term solutions." },
    { icon: <Smile size={20} />, label: "Aligners", desc: "Braces and clear aligner consultations." },
    { icon: <Users size={20} />, label: "Cosmetic", desc: "Cosmetic improvements for smile confidence." },
  ];
      ...
      <header className="relative overflow-hidden pt-36 pb-24 lg:pt-48 lg:pb-36 bg-gradient-to-b from-[#070b19] to-[#0e1428] border-b border-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="mb-16 lg:mb-24 flex items-center gap-2.5 text-xs text-slate-400 font-semibold tracking-wider uppercase">
            ...
            <ChevronRight size={12} className="text-slate-600 stroke-[3]" />
            <span className="text-[#f2bf38]">Vanasthalipuram</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-8 text-left">
              <div className="inline-flex items-center gap-2.5 bg-[#f2bf38]/10 border border-[#f2bf38]/20 px-4 py-1.5 rounded-full">
                ...
                <span className="text-[11px] font-bold tracking-widest text-[#f2bf38] uppercase">Branch 2: Vanasthalipuram</span>
              </div>
              ...
              <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl font-normal border-l-2 border-[#f2bf38]/40 pl-5 py-2">
                Our Vanasthalipuram branch brings modern dental care to patients looking for accessible treatment close to home. We combine clinical precision with a warm, patient-friendly approach so every appointment feels more manageable and less stressful.
              </p>
            ...
            <div className="lg:col-span-6">
              <a
                href="https://www.google.com/maps/search/?api=1&query=National+Dental+Care+Vanasthalipuram+Hyderabad"
              ...
              >
                <div className="p-6 sm:p-8 space-y-6">
                  ...
                  <div className="bg-[#050711] p-3 rounded-lg border border-slate-800/60 flex items-center justify-between text-xs">
                    <div>
                      <p className="font-bold text-white text-[11px]">Vanasthalipuram Clinic</p>
                      <span className="text-[9px] text-slate-400">Above D Mart, Hyderabad 500070</span>
                    </div>
                    <span className="text-[9px] font-mono font-bold bg-slate-900 border border-slate-800 px-2 py-1 rounded text-[#f2bf38]">INDEX-02</span>
                  </div>
                </div>
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              ...
              <blockquote className="text-2xl sm:text-3xl font-black text-white leading-snug">
                "Dental care that's simple, clear, and stress-free."
              </blockquote>
              <p className="text-slate-400 text-base leading-relaxed">
                We understand that patients often delay dental treatment because of fear, confusion, or lack of time. At our Vanasthalipuram branch, we work to make the experience simpler by offering clear consultations, supportive communication, and treatment plans that are easy to understand.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3 gap-4">
              {[
                { icon: <MessageCircle size={20} />, title: "Clear Consultations", desc: "Straightforward explanations before any treatment begins." },
                { icon: <Heart size={20} />, title: "Supportive Team", desc: "A friendly team that makes every visit less daunting." },
                { icon: <ClipboardList size={20} />, title: "Easy Plans", desc: "Treatment plans you can read, understand, and trust." },
              ].map((p) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-between gap-8">
              <div className="space-y-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-white leading-tight">
                  Located above D Mart,<br/>
                  <span className="text-[#f2bf38]">Vanasthalipuram</span>
                </h2>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Our Vanasthalipuram branch is on the 3rd floor above D Mart — a well-known landmark that makes it easy for patients and families across Hyderabad to find us.
                </p>
              </div>

              <div className="space-y-3">
                <a
                  href="https://www.google.com/maps/search/?api=1&query=National+Dental+Care+Vanasthalipuram+Above+D+Mart+Hyderabad+500070"
                  target="_blank" rel="noopener noreferrer"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs mt-0.5 leading-relaxed">National Dental Care, 3rd Floor, Above D Mart, Vanasthalipuram, Hyderabad 500070</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <a href="tel:+919030052369" className="flex items-center gap-3 bg-[#0d1526] hover:bg-[#111c35] border border-slate-800 hover:border-[#f2bf38]/30 rounded-2xl p-4 transition-all">
                    ...
                    <div>
                      ...
                      <p className="text-white text-xs font-black mt-0.5">+91 903 005 2369</p>
                    </div>
                  </a>
            ...
            >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative flex flex-col items-center">
                    ...
                    <div className="mt-3 bg-[#0d1526]/95 border border-slate-700 rounded-xl px-4 py-2 text-center shadow-lg">
                      ...
                      <p className="text-slate-400 text-[10px] mt-0.5">3rd Floor, Above D Mart, Vanasthalipuram</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-[#070b19] border-t border-slate-800 px-5 py-3 flex items-center justify-between">
                <div>
                  <p className="text-white text-xs font-bold">3rd Floor, Above D Mart</p>
                  <p className="text-slate-500 text-[10px] mt-0.5">Vanasthalipuram, Hyderabad 500070</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 space-y-3 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
              This branch is well-suited for patients seeking:
            </h2>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-slate-800">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-0">
              ...
              <div className="lg:col-span-4 bg-[#f2bf38] p-8 sm:p-10 flex flex-col justify-center gap-5">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900/50">Patient Experience</span>
                <h2 className="text-2xl sm:text-3xl font-black text-slate-950 leading-tight">
                  Informed.<br/>Comfortable.<br/>Trusted.
                </h2>
                <p className="text-slate-900/70 text-sm leading-relaxed">
                  Our goal is not just to treat a dental issue, but to make you feel informed and comfortable throughout the entire process.
                </p>
              </div>
              ...
              <div className="lg:col-span-8 bg-[#070b19] p-8 sm:p-10 flex flex-col justify-center gap-6">
                <p className="text-slate-300 text-base leading-relaxed max-w-xl">
                  Patients visiting this branch can expect careful attention, transparent planning, and a team that values trust. We believe that when patients understand their care, they feel in control — and that makes all the difference.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    "Careful attention at every appointment",
                    "Transparent treatment planning throughout",
                    "A team that genuinely values your trust",
                    "No surprises — just clear, honest care",
                  ].map((pt) => (
      ...
      <section id="cta-section" className="relative py-20 px-6 bg-[#1E293B] text-white overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-light">
            For patients in and around Vanasthalipuram, Dharma Dental Care offers a dependable space for complete dental care with a personal touch.
          </p>
          <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="tel:+919030052369" className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 text-white font-semibold py-4 px-8 rounded-full border border-white/20 transition-all duration-300">
