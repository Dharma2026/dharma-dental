  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-150 h-150 bg-yellow-400/5 rounded-full blur-[120px]" />
        <div className="absolute top-[5%] right-[-5%] w-112.5 h-112.5 bg-blue-500/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-[10%] left-[25%] w-87.5 h-87.5 bg-yellow-300/5 rounded-full blur-[90px]" />
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-yellow-400/50 to-transparent origin-left"
      />
      ...
      <motion.div style={{ opacity }} className="relative z-10 w-full max-w-7xl mx-auto">
        <motion.div initial="hidden" animate="visible" variants={stagger}>
          ...
          >
            <div className="flex items-center gap-2 text-slate-500 transition-colors duration-300 text-[11px] font-bold uppercase tracking-[0.2em] group">
            ...
            <motion.div variants={fadeUp} className="flex items-center gap-3 mb-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.div
                  ...
                  className="h-px w-12 bg-linear-to-r from-yellow-400 to-transparent origin-left"
                />
              </div>
            </motion.div>

            <motion.div variants={fadeUp} className="mb-6">
              <h1 className="text-5xl md:text-6xl lg:text-6xl font-black text-white leading-[1.1] uppercase tracking-tight">
                Contact <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-400 via-yellow-200 to-yellow-500">Dharma Dental Care</span>
              </h1>
            </motion.div>

            <motion.p
              variants={fadeUp}
              className="text-slate-400 text-lg md:text-xl leading-relaxed max-w-2xl font-serif italic mb-10 opacity-80"
            >
              Getting in touch with the right dental team should feel simple and stress-free. Whether you want to book an appointment, ask about a treatment, or find the nearest branch, Dharma Dental Care is here to help.{' '}
              <span className="text-yellow-400/50 text-xs tracking-widest font-sans not-italic">dharmadentalcare</span>
            </motion.p>
